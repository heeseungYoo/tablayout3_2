...
public class MainActivity extends AppCompatActivity {
    ...
    static ArrayList<Point> myPaths = new ArrayList<>();
    static ArrayList<Point> undoneMyPaths = new ArrayList<>();
    ...
    private int[] btns = {R.id.btnRED, R.id.btnBLUE, R.id.btnGREEN, R.id.btnWHITE, R.id.btnERASE};
    ...
    public void btnClickBack(View view) {
        ...
        for (int i=0;i<btns.length;i++)
        {
            ...
            {
                if(myPaths.size() > 0) {
                    undoneMyPaths.add(myPaths.remove(myPaths.size() -1));
